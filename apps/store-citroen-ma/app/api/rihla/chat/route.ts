...
function buildApvOverrideBlock(): string {
  return [
    ...
    "A Jeep dealership / showroom / agency is ALWAYS called \"la maison\" (Latin script, even inside Arabic / Darija sentences). Singular = \"la maison\", plural = \"les maisons\". This is Stellantis's brand positioning (\"La Maison Jeep\"). Apply this BEFORE any other speech rule.",
    "",
